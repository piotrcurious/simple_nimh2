...
// Charging constants
const float MAX_TEMP_DIFF_THRESHOLD = 0.6f;
const float MIN_TEMP_DIFF_THRESHOLD = 0.30f;
...
const float MAX_PULSE_CYCLE_LENGTH_S = 120.0f;                  // Maximum clamped duration for the combined charge pulse cycle (s)
