...
static constexpr uint32_t ADC_SAMPLE_RATE_HZ = 80000; // Lower rate allows sampling capacitor to settle completely.higher rates allow more data for averaging.
