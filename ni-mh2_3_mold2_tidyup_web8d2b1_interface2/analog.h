 ...
 *
 * This function reads the analog value from the specified pin. If the DMA system is active,
 * it returns the latest DMA-averaged millivolt reading. Otherwise, it performs a
 * synchronous oversampled read.
 *
